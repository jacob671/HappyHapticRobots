...
public class AutoTest4 extends OpMode {
    ...
    private void buildPaths() {
        ...
        readyForHumanPath1 = new Path(new BezierLine(new Point(specimen1PushPose), new Point(readyForHuman)));
        readyForHumanPath1.setLinearHeadingInterpolation(specimen1PushPose.getHeading(), readyForHuman.getHeading());
        ...
        pushPath = new PathChain(specimen1Path, specimen1StrafePath, specimen1PushPath, readyForHumanPath1);
