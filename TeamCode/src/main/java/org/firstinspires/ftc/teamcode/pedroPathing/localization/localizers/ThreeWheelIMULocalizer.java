...
public class ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.000581206;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.0005670278;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.0005126725;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(4.2, 2.5, 0);
        rightEncoderPose = new Pose(4.2, -2.5, 0);
        strafeEncoderPose = new Pose(-4.25, 0.3, Math.toRadians(90));


        // TODO: replace these with your encoder ports
        leftEncoder  = new Encoder(hardwareMap.get(DcMotorEx.class, "VLEncoder"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "VREncoder"));
