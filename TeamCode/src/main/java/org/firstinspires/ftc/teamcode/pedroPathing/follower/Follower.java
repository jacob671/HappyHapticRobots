...
public class Follower {
    ...
    public void initialize() {
        ...
        frontLeftMotor = hardwareMap.get(DcMotorEx.class, leftFrontMotorName);
        backLeftMotor = hardwareMap.get(DcMotorEx.class, leftRearMotorName);
        backRightMotor = hardwareMap.get(DcMotorEx.class, rightRearMotorName);
        frontRightMotor = hardwareMap.get(DcMotorEx.class, rightFrontMotorName);
        frontLeftMotor.setDirection(leftFrontMotorDirection);
        backLeftMotor.setDirection(leftRearMotorDirection);
        frontRightMotor.setDirection(rightFrontMotorDirection);
        backRightMotor.setDirection(rightRearMotorDirection);

        motors = Arrays.asList(frontLeftMotor, backLeftMotor, frontRightMotor, backRightMotor);
